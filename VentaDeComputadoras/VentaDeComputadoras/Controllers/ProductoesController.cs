...
namespace VentaDeComputadoras.Controllers
{
    ...
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_producto,NombreProducto,descripcion,estadoProducto,precio,marca")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_producto,NombreProducto,descripcion,estadoProducto,precio,marca")] Producto producto)
        {
